...
typedef struct sLoRaMacCallback
{
    ...
    void ( *TxDone ) ( bool );
    void ( *DevTime ) ( uint32_t );
    void ( *LinkCheck ) ( uint8_t );
    void ( *TxTimeout ) ( void );
    int8_t ( *GetChPower ) ( uint8_t );
    // @
}LoRaMacCallback_t;
...
//@plantus
void OnRadioAckSend( void );
void LoRaMacStandby( void );
uint8_t GetLoRaMacFlags( void );
//@
